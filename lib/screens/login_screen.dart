  ...
  Future<void> _handleLogin() async {
    ...
    if (errorMsg == null) {
      ...
      if (needsVerification) {
        // Switch view to verification state seamlessly
        await auth.resendVerificationEmail(email: _emailController.text.trim());
        setState(() {
          isLoading = false;
      ...
      children: [
        ...
        Align(
          ...
          child: TextButton(
            ...
            child: const Text('Forgot Password?', style: TextStyle(fontWeight: FontWeight.w600, color: AppColors.primary)),
          ),
        ),
        ...
        ElevatedButton(
          ...
          child: isLoading 
              ...
              : const Text('LOG IN', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
        ),
        const SizedBox(height: 20),
        ...
        Center(
          child: TextButton.icon(
            ...
            label: const Text('Login with OTP', style: TextStyle(fontWeight: FontWeight.w600)),
            style: TextButton.styleFrom(
